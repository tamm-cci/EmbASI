...
def test_fdet_gga_regression(num_regression: NumericRegressionFixture,
    ...
    calc = Aims(profile=AimsProfile(command="asi-doesnt-need-command"),
                ...
                xc='libxc GGA_C_APBE+GGA_X_APBE',
                relativistic="atomic_zora scalar",
                spin="none",
                xc_nakp="libxc GGA_K_REVAPBE",
                xc_naxcp="libxc GGA_C_APBE+GGA_X_APBE",
                )
