...
consistently, with an MP2 correlation correction added non-self-
...
root_print('\nRunning MeOH monomer (MP2-in-PBE0)\n')
Projection.run()
root_print('Finished running MeOH monomer\n')

# Total energy for the embedded fragment, including the MP2 correction:
...
root_print(f"Final MP2-in-PBE0 total energy: {meoh_mp2inpbe0_energy} eV")
root_print(f"MP2 correlation correction (A_HL only): {mp2_correction} eV")
