...
class ChemShellInterface(ProjectionEmbedding):
    ...
    def __init__(self, embed_mask, mu_val=1.e+6, ll_calc_config=None, hl_calc_config=None, multipoles=None, **kwargs):
        ...
        super().__init__(embed_mask=self.embed_mask, calc_base_ll=self.calc_ll,
                        calc_base_hl = self.calc_hl, mu_val=mu_val, **kwargs)
